...
function SearchListing(listing, callback) {
    ...
    var query = "SELECT * FROM realtor.listings LEFT JOIN realtor.images ON realtor.listings.listing_id = realtor.images.listing_id LEFT JOIN realtor.address ON realtor.listings.listing_id = realtor.address.listing_id where realtor.listings.listing_price >= ? and realtor.listings.listing_price <= ? or realtor.listings.listing_number_of_beds >= ? and realtor.listings.listing_number_of_beds <= ? or realtor.listings.listing_number_of_baths >= ? and realtor.listings.listing_number_of_baths <= ? or  realtor.address.listing_city = ? or realtor.address.listing_zipcode = ? or realtor.address.listing_state = ?";   
